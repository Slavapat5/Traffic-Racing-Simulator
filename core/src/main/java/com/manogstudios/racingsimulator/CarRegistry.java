...
public class CarRegistry {
    ...
    static {
        ...
        statsMap.put("Mazda MX-5 Miata - 2014.png", sazdaFx5); // old backup name
        ...
        statsMap.put("Ford Fiesta ST - 2019.png", nordSesta); // old backup name
        ...
        statsMap.put("Volkswagen Golf GTI Mk8 - 2019.png", slovagenBall); // old backup name
        ...
        statsMap.put("BMW 330i - 2025.png", dmv365e); // old backup name
        ...
        statsMap.put("Ferrari 458 - 2015.png", ferrati460); // old backup name
        ...
        statsMap.put("Lamborghini Huracan - 2015.png", lambiniUragan); // old backup name
        ...
        statsMap.put("Mclaren 650s - 2015.png", solaren660z); // old backup name
        ...
        statsMap.put("Ferrari SF90 Stradale - 2024.png", ferratiSfx900); // old backup name
        ...
        statsMap.put("DOJ Challenge RST Hellbunny - 2023.png", hellbunny); // old backup name
        ...
        statsMap.put("2010 Sedecrem STR Solaren - Gray.png", sedecremStr);
